...
) : IRequestEventHandlerService
{
    ...
    public async Task<bool> AssignTaskToApprover(Guid requestId, Guid teacherApproverId, Guid HODApproverId, bool requesterIsTeacherOfTargetLab, CancellationToken cancellationToken)
    {
